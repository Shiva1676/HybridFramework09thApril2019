 ...
 *
 */
public class LoginTestCase9 extends BaseClass {
	...
	public void loginToApplication() {
		...
		boolean status = login.loginToApplication(DataProviderFactory.getExcel().getData("Sheet1", 0, 0),
				DataProviderFactory.getExcel().getData("Sheet1", 0, 1));
